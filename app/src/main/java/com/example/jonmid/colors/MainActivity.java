...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtr = (TextView) findViewById(R.id.id_tvr);
        txtg = (TextView) findViewById(R.id.id_tvg);
        txtb = (TextView) findViewById(R.id.id_tvb);
        txta = (TextView) findViewById(R.id.id_tva);
